...
const projects = [
  ...
  },
  {
    ...
    description:
      'This is a RESTful API that leverages the power of puppeteer to crawl and scrape mangareader.net providing any HTTP/HTTPS capable client the ability to filter manga searches and read/retrieve manga. Be sure to check out the api documentation at manga-back.webdeveloperbeau.com!',
  },
  {
    image: 'translator',
  ...
  },
  {
    ...
    icons: ['SvgJavascript'],
    description:
      'More akin to notes, these are datastructures I have implemented using javascript. Includes singly and doubly linked lists. Coming soon: stacks, queues, BSTs, heaps, hash tables, and graphs. Photo credit => https://dev.to/',
  },
];
                ...
                <Card className={classes.cardRoot}>
                  {project.live && (
                    <a className={classes.anchorTag} href={project.live} aria-label={project.title}>
                      <CardMedia className={classes.linkableMedia} image={'/imgs/' + project.image + '.png'} />
                    </a>
                  )}
                  {!project.live && <CardMedia className={classes.media} image={'/imgs/' + project.image + '.png'} />}
